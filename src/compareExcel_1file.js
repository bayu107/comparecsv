...
if (file1 && file2) {
    ...
    // Fungsi untuk menambahkan hasil perbandingan ke dalam file yang sama
    ...
    compareColumns.forEach(column => {
        ...
        // Tentukan path output file yang sama
        const outputFilePath = path.join(resultFolder, 'comparison_result.csv');
